...
with(epc.subset, {
  plot(epc.subset$Date_Time, epc.subset$Global_active_power, type = "l", ylab = "Global Active Power", cex.lab = 0.6, cex.axis = 0.5, xlab = "")
  plot(epc.subset$Date_Time, epc.subset$Voltage, type = "l", ylab = "Voltage", xlab = "datetime", cex.lab = 0.6, cex.axis = 0.5)
  plot(epc.subset$Date_Time, epc.subset$Sub_metering_1, type = "l", ylab = "Energy sub metering", cex.lab = 0.6, cex.axis = 0.5, xlab = "", col = "black")
  ...
  legend("topright", col = c("black", "red", "blue"), legend = c("Sub_metering_1", "Sub_metering_2", "Sub_metering_3"), lty = 1, cex = 0.3, bty = "n")
  plot(epc.subset$Date_Time, epc.subset$Global_reactive_power, type = "l", ylab = "Global_reactive_power", cex.lab = 0.6, cex.axis = 0.5, xlab = "datetime")
})
